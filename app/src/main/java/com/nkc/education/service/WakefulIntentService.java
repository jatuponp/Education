...
public class WakefulIntentService extends IntentService {
    public static final String LOCK_NAME_STATIC = "com.nkc.education.TaskButlerService.Static";
    public static final String LOCK_NAME_LOCAL = "com.nkc.education.TaskButlerService.Local";
